...
import PokeItemReducer from '../../store/reducers/PokeItemReducer';


describe('<PokeItemReducer />', () => {
	it('return initial state', () => {
		expect(
			PokeItemReducer(undefined, {})
		).toEqual({
			pokemonsData : []
		})
	})

	it('fetching pokemon data', () => {
		expect(
			PokeItemReducer(undefined, {
